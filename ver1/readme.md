...
Атрибут margin (внутри узла): Используется для отступа текста от границ узла, что косвенно меняет восприятие пространства. node [shape=box, margin="0.2,0.1"]; // 0.2 - отступ по горизонтали, 0.1 - по вертикали. См. https://github.com/bpmbpm/family-tree/pull/24
