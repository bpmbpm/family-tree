...
- `idA` листа `family` формируется автоматически, т.е. id семьи будет: `Кононов_Андрей_Николаевич__Обозова_Прасковья_Михайловна` (разделитель - двойной прочерк `__`)
...
Результаты шагов 4-6 см. family-tree-step4-6.7z.zip https://github.com/bpmbpm/family-tree/blob/main/ver6/old/family-tree-step4-6.7z.zip
