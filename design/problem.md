...
### 4 Вопросы ведения инфо в excel
...
2. Смена id персоны. Например, стало известно отчество и нужно сделать замену id (без отчества) на всех листах и также в именах файлов, включая фото и md (pdf). 
